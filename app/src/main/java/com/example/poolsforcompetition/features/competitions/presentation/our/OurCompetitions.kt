...
class OurCompetitions : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_competition_list_our, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = OurCompetitionAdapter(competitionList, listener)
            }
        }
        return view
    }
